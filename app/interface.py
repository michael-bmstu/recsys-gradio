...
def recomend(r1, r2, r3, slider):
    ...
    anime_id = utils.get_best_anime(cluster, anime_genre, genres)
...
def create_interface():
    ...
    with app_interface:
        r1 = gr.Dropdown(choices=genres, label='good', multiselect=True, interactive=True)
        r2 = gr.Dropdown(choices=genres, label='normal', multiselect=True, interactive=True)
